 ...
 */
@Entity
@Table(uniqueConstraints = { @UniqueConstraint(columnNames = { "name", "travellerId" }) })
public class Travel extends ModelBase
{
    ...
    public String toString() {
        return String.format("%s[id=%d, name=%s, organizer=%s]", getClass().getSimpleName(), getId(), name, organizer);
    }
}
